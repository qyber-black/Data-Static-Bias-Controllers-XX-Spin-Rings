function [tau,taulog]=JTanalysis_vs(sensitivity,s)
%
...
%
% The difference between this 'version s' and the first version is that
% the scaling (number of bins) can be adjusted in this one 
